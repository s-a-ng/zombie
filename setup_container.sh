...
powershell -Command "Set-MpPreference -DisableRealtimeMonitoring:1; Enable-WindowsOptionalFeature -Online -FeatureName Microsoft-Hyper-V -All -NoRestart; Stop-Computer -Force"
EOF
